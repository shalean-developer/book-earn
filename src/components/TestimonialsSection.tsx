...
const FALLBACK_TESTIMONIALS: Testimonial[] = [
  {
    ...
    rating: 5,
    text:
      "BookPro made finding a reliable cleaner so easy! The booking process was seamless and the service was exceptional.",
  },
  {
    id: "fallback-2",
    name: "Michael Chen",
    ...
    rating: 5,
    text:
      "As a business owner, I list my services here and get consistent bookings. The platform is fantastic for growing my client base.",
  },
  {
    id: "fallback-3",
    ...
    rating: 5,
    text:
      "I manage 15 properties and BookPro has been a lifesaver. Quick booking, verified professionals, and great support.",
  },
];
